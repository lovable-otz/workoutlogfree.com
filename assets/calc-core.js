 ...
 *   }
 * The engine renders the form, recomputes live on every change, formats money/percent, keeps the state
 * in the URL hash (so a result can be shared/bookmarked), and prints cleanly.
 *
